...
jQuery(function()
{
	...
	var Gaper = function(el)
	{
		this.initialize = function()
		{
			...
			this.interval = setInterval(this.spawnSprite.bind(this, LeftSkier, this.container, this.laneOneArray, 65), 10000/this.level);
			this.intervalTwo = setInterval(this.spawnSprite.bind(this, RightSkier, this.container,  this.laneThreeArray, 185), 10000/this.level);
		}
