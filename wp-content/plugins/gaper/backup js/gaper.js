...
jQuery(function()
{
	...
	var Gaper = function(el)
	{
		this.initialize = function()
		{
			...
			// This sets an interval that makes the sprites spawn in the first lane
			...
			this.intervalTwo = function()
				{
					setInterval(this.spawnSprite.bind(this, RightSkier, this.laneThree, this.laneThreeArray, this.laneThreeDist), 5000/this.speed);
				};
			this.intervalThree = function()
				{
					setInterval(this.spawnSprite.bind(this, LeftSkier, this.laneFive, this.laneFiveArray, this.laneFiveDist), 5000/this.speed);
				};
		}
		this.nextLevel = function() 
		{
			...
			{
				this.laneOneArray[i].sprite.remove;
			}
			for (i=0; i<this.laneThreeArray.length; i++)
			{
				this.laneThreeArray[i].sprite.remove;
			}
			for (i=0; i<this.laneFiveArray.length; i++)
			{
				this.laneFiveArray[i].sprite.remove;
			}
